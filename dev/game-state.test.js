...
const dustExchange = GameState.purchaseMarketItem(Engine.normalizeSaveState({ ...manual.state, glassDust: 10 }), 'glassdust_sigils', null, { transactionId: 'dust-1' });
...
assert.strictEqual(GameState.purchaseMarketItem(manual.state, 'glassdust_sigils', null, { transactionId: 'dust-empty' }).errorCode, 'INSUFFICIENT_DUST');
