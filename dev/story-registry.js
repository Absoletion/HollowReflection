  ...
  chapters: [
    {
      ...
      missions: [
        ...
        { id: 'act1_3', code: '1-3', title: 'Field Readiness', type: 'battle', encounter: 'act1_3', lesson: 'Burst at 300 Energy', party: ['hale', 'cinnia', 'tobin', 'hearthgar'], unlocks: { units: ['hearthgar'] },
          pre: [{ sp: 'Tobin', tx: 'The water says the next one is louder.' }, { sp: 'Hearthgar', tx: 'S-stay behind me. The armor means it, even if I do not sound like it.' }, { sp: 'Cinnia', tx: 'Three hundred Energy. Swipe twice for Burst. Make the loud one regret volunteering.' }],
